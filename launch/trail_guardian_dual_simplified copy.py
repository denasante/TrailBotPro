...
Single launch file with staged spawns (TimerAction) to avoid Ogre2 concurrent
lighting modification races: Husky first, then Parrot after 15s.
"""
...
def generate_launch_description():
    ...
    # Delay Husky a tiny bit to ensure Gazebo world fully initializes
    ...
    # Delay Parrot by 15s AFTER Husky's 2s = total ~17s from world bring-up
    delayed_parrot = TimerAction(period=17.0, actions=[parrot_group])
